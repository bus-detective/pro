...
default_demograpgic_fields = [
  ...
  {"percentage_hispanic", "pct_Hispanic_ACS_09_13", "Hispanic", "ethnicity", "#4B3C8D"},
  {"percentage_asian", "pct_NH_Asian_alone_ACS_09_13", "Asian", "ethnicity", "#BBDBE5"},
  ...
  {"percentage_hawiian", "pct_NH_NHOPI_alone_ACS_09_13", "Pacific Islander", "ethnicity", "#5bc0de"},
